...
function Scroll() {
  ...
  return (
    <div className='flex items-center mt-[300px] h-[400vh] w-full flex-col [perspective:1000px] [transform-style:preserve-3d]'>
       <motion.h1 
       style={{
        scale:textScale,
        opacity,
       ...
       className='font-bold text-center text-4xl'>Unleash the power of <br/>Trading</motion.h1>
      <motion.div 
      style={{
       rotateX:rotateX,
       translateZ:"50px",
      ...
      className='bg-white border border-neutral-100 w-[500px] h-[400px] -mt-8 p-2 rounded-3xl '>
